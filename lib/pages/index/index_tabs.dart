...
import 'package:new_flutter/pages/musicPlayer/music_player.dart';
...
class IndexTabState extends State<IndexTabs> {
  ...
  final List<BottomNavigationBarItem> bottomTabs = [
    BottomNavigationBarItem(
        icon: Image.asset("${Constant.ASSETS_IMG}icon_discover_normal.png",
            width: 30, height: 30),
        activeIcon: Image.asset(
            "${Constant.ASSETS_IMG}icon_discover_seleced.png",
            width: 30,
            height: 30),
        label: "发现"),
    BottomNavigationBarItem(
        icon: Image.asset(
          "${Constant.ASSETS_IMG}icon_broadcast_normal.png",
          width: 30,
          height: 30,
        ),
        activeIcon: Image.asset(
            "${Constant.ASSETS_IMG}icon_broadcast_selected.png",
            width: 30,
            height: 30),
        label: "播客"),
    BottomNavigationBarItem(
        icon: Image.asset(
          "${Constant.ASSETS_IMG}icon_mine_normal.png",
          width: 30,
          height: 30,
        ),
        activeIcon: Image.asset("${Constant.ASSETS_IMG}icon_mine_selected.png",
            width: 30, height: 30),
        label: "我的"),
    BottomNavigationBarItem(
        icon: Image.asset(
          "${Constant.ASSETS_IMG}icon_care_normal.png",
          width: 30,
          height: 30,
        ),
        activeIcon: Image.asset("${Constant.ASSETS_IMG}icon_care_selected.png",
            width: 30, height: 30),
        label: "关注"),
    BottomNavigationBarItem(
      icon: Image.asset(
        "${Constant.ASSETS_IMG}icon_community_normal.png",
        width: 30,
        height: 30,
      ),
      activeIcon: Image.asset(
          "${Constant.ASSETS_IMG}icon_community_selected.png",
          width: 30,
          height: 30),
      label: "社区",
    ),
